...
<div class="col-12">
    ...
    <div class="col-12 text-center">
        <input type="submit" class="btn btn-danger waves-effect waves-light" value="Edit supplier">
    </div>
</div>
            </form>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                mobile_no: {
                    required : 'Please Enter The Mobile number of the supplier',
                },
                email: {
                    required : 'Please Enter The Email address of the supplier',
                },
                address: {
                    required : 'Please Enter The full address of the supplier',
                },
            },
            errorElement : 'span', 
